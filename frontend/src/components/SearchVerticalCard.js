          ...
          return (
            ...
            >
              ...
              <div className="p-4 grid gap-3">
                <h2 className="font-medium text-base md:text-lg text-ellipsis py-2 line-clamp-1 text-black dark:text-white animate-pulse p-1 rounded-full bg-slate-200 dark:bg-gray-700"></h2>
        ...
        : data.map((product, index) => {
          return (
            <Link
              ...
              onClick={scrollTop}
            >
              <div className="bg-slate-300 dark:bg-gray-700 h-48 p-4 min-w-[120px] md:min-w-[145px] flex justify-center items-center">
                <img
